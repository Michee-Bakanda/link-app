...
const PreviewCard = ({ogTitle='untitled', ogDescription='No description found', ogImage='https://www.myactivechurch.org/wp-content/uploads/2018/02/Active-Church-Top-Header-2.png'}) => {
  return (
